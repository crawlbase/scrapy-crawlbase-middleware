...
class CrawlbaseRequest(Request):
    ...
    def __init__(self, url, original_url=None, response_format='html', user_agent=None, page_wait=None, ajax_wait=False,
        ...
        Docs: https://crawlbase.com/dashboard/api/docs
        ...
        screenshot: boolean
            ...
            get a screenshot in JPEG response_format of the whole crawled page. Crawlbase will send you back the screenshot_url
